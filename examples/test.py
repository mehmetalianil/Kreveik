...
for i in xrange(100):
    ...
    a = network.generators.random(10, network.boolfuncs.xor_masking_C, 
...
for i in xrange(200):
    logging.info(str(i)+"th iteration")
    ...
    for j in xrange(1):
        ...
        meanindegree.append(num.array([network.indegree() for network in petri]).mean())
        meanoutdegree.append(num.array([network.outdegree() for network in petri]).mean())
