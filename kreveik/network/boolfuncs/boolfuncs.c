...
static PyObject* xor_masking_c_p(PyObject *self, PyObject *args);
static PyObject* or_masking_c(PyObject *self, PyObject *args);
static PyObject* and_masking_c(PyObject *self, PyObject *args);
static PyObject* advance_c_p(PyObject *self, PyObject *args);
...
static PyMethodDef boolfuncs_c[] = {
        ...
        {"xor_masking_c_p", xor_masking_c_p, METH_VARARGS, doc_xor_p},
        {"advance_c_p", advance_c_p, METH_VARARGS, doc_advance_c_p},
...
static PyObject* xor_masking_c_p(PyObject *self, PyObject *args){
    ...
    #pragma omp parallel for shared(dims, j , i ,adj_value_ptr, mask_value_ptr, state_value_ptr, adjacency_arr,mask_arr,state_arr,state_out_ptr)
